  ...
  describe('#getValueFromSource()', () => {
    ...
    beforeEach(() => {
      getValueFromSlsStub = sinon
        .stub(serverless.variables, 'getValueFromSls')
        .resolves('variableValue');
      getValueFromEnvStub = sinon
        .stub(serverless.variables, 'getValueFromEnv')
        .resolves('variableValue');
      ...
      getValueFromFileStub = sinon
        .stub(serverless.variables, 'getValueFromFile')
        .resolves('variableValue');
      getValueFromCfStub = sinon
        .stub(serverless.variables, 'getValueFromCf')
        .resolves('variableValue');
      getValueFromS3Stub = sinon
        .stub(serverless.variables, 'getValueFromS3')
        .resolves('variableValue');
      getValueFromSsmStub = sinon
        .stub(serverless.variables, 'getValueFromSsm')
        .resolves('variableValue');
    });
